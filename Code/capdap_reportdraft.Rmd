...
Tick population density makes sense as a response variable, rather than total tick population. Let's graph tick population density to see what the distribution looks like.
```{r}
